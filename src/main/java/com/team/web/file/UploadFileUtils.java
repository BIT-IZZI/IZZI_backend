...
public class UploadFileUtils {
    ...
    private static final String contextPath = "https://s3.ap-northeast-2.amazonaws.com/web.izzi.com"; // https://s3.ap-northeast-2.amazonaws.com/버킷네임/ @RequestMapping(value = "/imgUpload" 라서 imgUpload
    private static final String bucketName = "web.izzi.com"; //AWS S3 생성한 버킷네임.
    ...
    public static String uploadFile(String uploadPath, String originalName, byte[] byteData) throws Exception {
        ...
        logger.info("web.izzi.com : "+uploadPath);
